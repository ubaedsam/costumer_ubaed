...
<head>
    ...
    <meta charset="utf-8" />
    <title>Create New Password | Velzon</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2">
                                  <form action="{{ route('user.reset.password') }}" method="POST" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="email" class="form-control" value="{{ $email ?? old('email') }}" name="email" id="email" placeholder="Enter Email">
                              ...
                              @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Confirm password">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Wait, I remember my password... <a href="{{ route('user.login') }}" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                        </div>
